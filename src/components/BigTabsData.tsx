...
export const BigTabsData = () => {
  ...
  return (
    <section className="w-full pt-2 pb-12 relative overflow-hidden bg-transparent">
      <div className="max-w-[1400px] mx-auto px-5 relative z-10 flex flex-col items-center justify-center text-center">
        ...
        <div className="max-w-3xl mb-8">
          <h2 className="text-[#1a1a1a]">Platform Mastery <span className="text-[#10B981]">Overview</span></h2>
          <p className="text-gray-600">Explore the tools, architecture, and principles needed to build high-performance applications.</p>
        </div>
        ...
        <div className="w-full text-left max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-[280px_1fr] overflow-hidden min-h-[600px]">
            ...
            {tabsData.map((tab) => (
              <button
                ...
                className={`
                  ...
                  ${activeTabId === tab.id
                    // Active State: Emerald text, subtle emerald background, bottom/left indicator line
                    ? 'text-[#10B981] bg-[#10B981]/[0.08] before:content-[""] before:absolute before:left-0 before:bg-[#10B981] before:shadow-[0_0_15px_rgba(16,185,129,0.5)] before:w-full before:h-[3px] before:top-auto before:bottom-0 lg:before:w-[4px] lg:before:h-auto lg:before:top-0 lg:before:bottom-0'
                    // Inactive State: Slate text, light hover
          ...
          <main className="p-8 lg:p-[3rem_4rem] relative">
            <div key={activeTabId} className="animate-[fadeIn_0.4s_ease-out]">
              ...
              <h2 className="text-gray-900 mb-6 max-w-[800px] text-3xl font-bold">
                {activeContent.titlePre} <span className="text-[#10B981]">{activeContent.highlight}</span>
              </h2>

              <p className="text-gray-600 text-[1.1rem] font-normal leading-[1.7] mb-12 max-w-[700px]">
                {activeContent.intro}
              </p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                {activeContent.features.map((feature, idx) => (
                  <div key={idx} className="flex flex-col gap-3 group">
                    ...
                    <h3 className="text-gray-900 text-lg font-semibold m-0 flex items-center gap-2 after:content-['›'] after:text-[1.4rem] after:font-normal after:text-[#10B981] after:transition-transform after:duration-200 group-hover:after:translate-x-1">
                      {feature.title}
                    </h3>
                    <p className="text-gray-600 text-[0.95rem] leading-[1.5] m-0">
                      {feature.desc}
                    </p>
                  </div>
                ))}
              ...
              {/* Image Container */}
              <div className="w-full rounded-xl overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.08)] border border-gray-200 relative mt-auto group/img">
                <img
